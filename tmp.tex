...
\begin{lstlisting}[language=Python]
    ...
    output_img_filename=None):
        ...
        if output_img_filename != None:
            ...
            cv2.imwrite(output_img_filename, face)
        return face
\end{lstlisting}
